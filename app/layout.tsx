...
import { Sora, Space_Grotesk, DM_Sans, Playfair_Display, Inter } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${sora.variable} ${spaceGrotesk.variable} ${dmSans.variable} ${playfair.variable} ${inter.variable} h-full antialiased`}
    >
