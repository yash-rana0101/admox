...
const DEFAULT_GLOW_COLOR = '37, 105, 81'; // Ocean Teal
...
const cardData: BentoCard[] = [
  {
    color: 'transparent',
    title: 'Brand Films',
    description: 'Visual stories that define your digital identity.',
    label: 'Creative',
    icon: Film
  },
  {
    ...
    description: 'Smarter workflows with absolute human polish.',
    label: 'AI Precision',
    icon: Cpu
  },
  {
