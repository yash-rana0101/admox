...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ 
  ...
  return (
    <div
      ...
      className={cn(
        "absolute left-1/2 top-1/2 cursor-pointer border transition-all duration-500 ease-in-out select-none",
        isCenter 
          ? "z-10 bg-brand-teal text-white border-brand-teal shadow-xl" 
          : "z-0 bg-white text-brand-onyx border-brand-subtle/40 hover:border-brand-teal/40 hover:shadow-lg",
