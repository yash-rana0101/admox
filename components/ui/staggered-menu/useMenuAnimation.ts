import { useCallback, useLayoutEffect, useRef, useState, MutableRefObject } from 'react';
...
export function useMenuAnimation(
  ...
  config: StaggeredMenuProps,
  refs: {
    panelRef: MutableRefObject<HTMLDivElement | null>;
    preLayersRef: MutableRefObject<HTMLDivElement | null>;
    plusHRef: MutableRefObject<HTMLSpanElement | null>;
    plusVRef: MutableRefObject<HTMLSpanElement | null>;
    iconRef: MutableRefObject<HTMLSpanElement | null>;
    textInnerRef: MutableRefObject<HTMLSpanElement | null>;
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const plusH = refs.plusHRef.current;
      const plusV = refs.plusVRef.current;
  ...
  const animateColor = useCallback(
    (opening: boolean) => {
      // Color animation disabled to let CSS handle theme switches
    },
    []
  );
